        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Notification Icon and Sign In Button Grouped -->
                    <div class="d-flex align-items-center">
                        <!-- Bell Icon Button -->
                        @if (auth()->check())
                            <a href="{{ route('notifications') }}" class="btn btn-info position-relative me-3">
                        ...
                        @else
                            <a href="{{ route('notifications.markAsRead') }}"
                                class="btn btn-info position-relative me-4">
                                <i class="fa fa-bell text-white"></i>
                                <span
                        ...
                        <!-- Modal for Sign In and Register -->
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="signInModalLabel">{{ __('Sign In') }}</h5>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" class="btn btn-link" id="switch-to-register">Don't
                                            have an account? Register</button>
                                        <button type="button" class="btn btn-link" id="switch-to-login"
                                            style="display: none;">Already have an account? Sign In</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <script>
                            // JavaScript to toggle between login and register forms in the modal
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">${{ $monthlyEarnings }}
                                            </div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">${{ $annualEarnings }}
                                            </div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Total Customers</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $totalCustomers }}
                                            </div>
                                        </div>
                                        <div class="col-auto">
